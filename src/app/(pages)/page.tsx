      ...
      >
        ...
        <div className="w-full flex justify-center items-center">
          <Particles
            ...
            refresh
          />
          <div className="items-center px-4 sm:px-10 h-[80vh] container flex flex-col-reverse md:flex-row gap-5 justify-between pt-20">
            <div className="flex flex-col gap-3 text-center md:text-left z-10">
              ...
              <div className="w-full flex gap-3 items-center justify-center md:justify-start mt-5">
                <Link
